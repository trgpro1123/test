...
public class PlayerSwordSlashSkillAttackState : PlayerState
{
    public System.Action OnCurrentSkill;
    public PlayerSwordSlashSkillAttackState(Player _player, PlayerStateMachine _playerStateMachine, string _animateBoolName) : base(_player, _playerStateMachine, _animateBoolName)
    {
    }
