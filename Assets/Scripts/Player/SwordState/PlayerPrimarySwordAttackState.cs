...
public class PlayerPrimarySwordAttackState : PlayerState
{
    ...
    public PlayerPrimarySwordAttackState(Player _player, PlayerStateMachine _playerStateMachine, string _animateBoolName) : base(_player, _playerStateMachine, _animateBoolName)
    {
    }
