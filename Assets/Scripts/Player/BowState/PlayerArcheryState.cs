...
public class PlayerArcheryState : PlayerState
{
    public System.Action OnCurrentSkill;
    public PlayerArcheryState(Player _player, PlayerStateMachine _playerStateMachine, string _animateBoolName) : base(_player, _playerStateMachine, _animateBoolName)
    {
    }
