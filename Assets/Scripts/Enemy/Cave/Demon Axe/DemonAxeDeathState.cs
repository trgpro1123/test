...
public class DemonAxeDeathState : EnemyState
{
    public Enemy_DemonAxe enemy;
    public DemonAxeDeathState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName,Enemy_DemonAxe _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName)
    {
        enemy=_enemy;
    }
