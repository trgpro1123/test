...
public class DemonAxeMoveState : DemonAxePatrolState
{

    public DemonAxeMoveState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName, Enemy_DemonAxe _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName, _enemy)
    {
    }
