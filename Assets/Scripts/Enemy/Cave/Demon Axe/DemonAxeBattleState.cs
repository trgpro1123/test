...
public class DemonAxeBattleState : EnemyState
{
    protected Enemy_DemonAxe enemy;

    private bool canAttackPlayer;

    public DemonAxeBattleState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName,Enemy_DemonAxe _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName)
    {
        enemy=_enemy;
    }
