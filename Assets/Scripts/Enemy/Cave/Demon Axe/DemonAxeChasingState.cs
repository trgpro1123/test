...
public class DemonAxeChasingState : EnemyState
{

    protected Enemy_DemonAxe enemy;
    protected Transform transformToMove;
    

    public DemonAxeChasingState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName,Enemy_DemonAxe _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName)
    {
        enemy=_enemy;
    }
