...
public class EvilWizradDeathState : EnemyState
{
    public Enemy_EvilWizrad enemy;
    public EvilWizradDeathState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName,Enemy_EvilWizrad _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName)
    {
        enemy=_enemy;
    }
