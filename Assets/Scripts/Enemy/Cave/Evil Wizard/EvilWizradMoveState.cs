...
public class EvilWizradMoveState : EvilWizradPatrolState
{

    public EvilWizradMoveState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName, Enemy_EvilWizrad _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName, _enemy)
    {
    }
