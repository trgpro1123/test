...
public class EvilWizradChasingState : EnemyState
{
    ...
    public EvilWizradChasingState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName,Enemy_EvilWizrad _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName)
    {
        enemy=_enemy;
    }
