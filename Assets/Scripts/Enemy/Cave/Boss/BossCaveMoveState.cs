...
public class BossCaveMoveState : BossCavePatrolState
{
    // Transform destination;

    public BossCaveMoveState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName, Enemy_BossCave _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName, _enemy)
    {
    }
