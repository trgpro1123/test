...
public class BossCaveDeathState : EnemyState
{
    public Enemy_BossCave enemy;
    public BossCaveDeathState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName,Enemy_BossCave _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName)
    {
        enemy=_enemy;
    }
