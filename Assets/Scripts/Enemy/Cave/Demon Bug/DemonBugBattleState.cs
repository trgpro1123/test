...
public class DemonBugBattleState : EnemyState
{
    protected Enemy_DemonBug enemy;

    private bool canAttackPlayer;

    public DemonBugBattleState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName,Enemy_DemonBug _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName)
    {
        enemy=_enemy;
    }
