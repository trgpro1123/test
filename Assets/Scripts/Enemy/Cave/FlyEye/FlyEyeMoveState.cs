...
public class FlyEyeMoveState : FlyEyePatrolState
{

    public FlyEyeMoveState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName, Enemy_FlyEye _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName, _enemy)
    {
    }
