...
public class FlyEyeBattleState : EnemyState
{
    protected Enemy_FlyEye enemy;

    private bool canAttackPlayer;

    public FlyEyeBattleState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName,Enemy_FlyEye _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName)
    {
        enemy=_enemy;
    }
