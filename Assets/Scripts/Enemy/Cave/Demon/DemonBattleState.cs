...
public class DemonBattleState : EnemyState
{
    protected Enemy_Demon enemy;

    private bool canAttackPlayer;

    public DemonBattleState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName,Enemy_Demon _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName)
    {
        enemy=_enemy;
    }
