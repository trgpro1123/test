...
public class DemonChasingState : EnemyState
{

    protected Enemy_Demon enemy;
    protected Transform transformToMove;
    

    public DemonChasingState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName,Enemy_Demon _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName)
    {
        enemy=_enemy;
    }
