...
public class HeavyKnightBattleState : EnemyState
{
    protected Enemy_HeavyKnight enemy;

    private bool canAttackPlayer;

    public HeavyKnightBattleState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName,Enemy_HeavyKnight _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName)
    {
        enemy=_enemy;
    }
