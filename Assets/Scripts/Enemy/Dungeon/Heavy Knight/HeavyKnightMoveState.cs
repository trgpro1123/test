...
public class HeavyKnightMoveState : HeavyKnightPatrolState
{

    public HeavyKnightMoveState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName, Enemy_HeavyKnight _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName, _enemy)
    {
    }
