...
public class HeavyKnightDeathState : EnemyState
{
    public Enemy_HeavyKnight enemy;
    public HeavyKnightDeathState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName,Enemy_HeavyKnight _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName)
    {
        enemy=_enemy;
    }
