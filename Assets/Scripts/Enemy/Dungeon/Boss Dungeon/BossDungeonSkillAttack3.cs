...
public class BossDungeonSkillAttack3 : MonoBehaviour
{
    ...
    private Enemy_BossDungeon enemy;
    private Player player;
    private GameObject objectToSpawn;

    public void SetUpSkill(GameObject _objectToSpawn,int _damage,float _attackSize,float _attackDistance,int _maxCount,float _radius,float _timeToNextCreateClone,Enemy_BossDungeon _enemy){
    ...
    private void Update() {
        ...
        if(timer<=0){
            ...
            newClone.GetComponent<BossDungeonClone>().SetUpSkill(enemy,damage,attackSize,attackDistance);
            maxCount--;
        }
    }
