...
public class HeavyKnightWithShieldMoveState : HeavyKnightWithShieldPatrolState
{

    public HeavyKnightWithShieldMoveState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName, Enemy_HeavyKnightWithShield _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName, _enemy)
    {
    }
