...
public class HeavyKnightWithShieldChasingState : EnemyState
{

    protected Enemy_HeavyKnightWithShield enemy;
    protected Transform transformToMove;
    

    public HeavyKnightWithShieldChasingState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName,Enemy_HeavyKnightWithShield _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName)
    {
        enemy=_enemy;
    }
