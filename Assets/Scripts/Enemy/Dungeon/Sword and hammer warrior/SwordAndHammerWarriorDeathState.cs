...
public class SwordAndHammerWarriorDeathState : EnemyState
{
    public Enemy_SwordAndHammerWarrior enemy;
    public SwordAndHammerWarriorDeathState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName,Enemy_SwordAndHammerWarrior _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName)
    {
        enemy=_enemy;
    }
