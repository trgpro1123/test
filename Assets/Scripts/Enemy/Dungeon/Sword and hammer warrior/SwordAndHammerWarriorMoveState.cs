...
public class SwordAndHammerWarriorMoveState : SwordAndHammerWarriorPatrolState
{

    public SwordAndHammerWarriorMoveState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName, Enemy_SwordAndHammerWarrior _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName, _enemy)
    {
    }
