...
public class CrossBowManMoveState : CrossBowManPatrolState
{

    public CrossBowManMoveState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName, Enemy_CrossBowMan _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName, _enemy)
    {
    }
