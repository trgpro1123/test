...
public class CrossBowManBattleState : EnemyState
{
    protected Enemy_CrossBowMan enemy;

    private bool canAttackPlayer;

    public CrossBowManBattleState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName,Enemy_CrossBowMan _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName)
    {
        enemy=_enemy;
    }
