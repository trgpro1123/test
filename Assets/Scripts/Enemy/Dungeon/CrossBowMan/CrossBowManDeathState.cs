...
public class CrossBowManDeathState : EnemyState
{
    public Enemy_CrossBowMan enemy;
    public CrossBowManDeathState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName,Enemy_CrossBowMan _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName)
    {
        enemy=_enemy;
    }
