...
public class WarriorChasingState : EnemyState
{

    protected Enemy_Warrior enemy;
    protected Transform transformToMove;
    

    public WarriorChasingState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName,Enemy_Warrior _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName)
    {
        enemy=_enemy;
    }
