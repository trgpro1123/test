...
public class WarriorBattleState : EnemyState
{
    protected Enemy_Warrior enemy;

    private bool canAttackPlayer;

    public WarriorBattleState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName,Enemy_Warrior _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName)
    {
        enemy=_enemy;
    }
