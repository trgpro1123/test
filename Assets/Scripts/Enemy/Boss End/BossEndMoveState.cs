...
public class BossEndMoveState : BossEndPatrolState
{
    // Transform destination;

    public BossEndMoveState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName, Enemy_BossEnd _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName, _enemy)
    {
    }
