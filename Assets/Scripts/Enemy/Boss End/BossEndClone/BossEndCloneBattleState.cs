...
public class BossEndCloneBattleState :EnemyState
{
    protected BossEndClone enemy;

    private bool canAttackPlayer;

    public BossEndCloneBattleState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName,BossEndClone _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName)
    {
        enemy=_enemy;
    }
