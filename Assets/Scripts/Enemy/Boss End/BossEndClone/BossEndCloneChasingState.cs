...
public class BossEndCloneChasingState : EnemyState
{
    ...
    public BossEndCloneChasingState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName,BossEndClone _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName)
    {
        enemy=_enemy;
    }
