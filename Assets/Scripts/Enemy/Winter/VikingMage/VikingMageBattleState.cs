...
public class VikingMageBattleState : EnemyState
{
    protected Enemy_VikingMage enemy;

    private bool canAttackPlayer;

    public VikingMageBattleState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName,Enemy_VikingMage _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName)
    {
        enemy=_enemy;
    }
