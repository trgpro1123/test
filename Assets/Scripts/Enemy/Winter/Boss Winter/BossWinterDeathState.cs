...
public class BossWinterDeathState : EnemyState
{
    public Enemy_BossWinter enemy;
    public BossWinterDeathState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName,Enemy_BossWinter _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName)
    {
        enemy=_enemy;
    }
