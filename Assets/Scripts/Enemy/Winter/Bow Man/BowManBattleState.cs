...
public class BowManBattleState : EnemyState
{
    protected Enemy_BowMan enemy;

    private bool canAttackPlayer;

    public BowManBattleState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName,Enemy_BowMan _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName)
    {
        enemy=_enemy;
    }
