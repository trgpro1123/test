...
public class Viking1MoveState : Viking1PatrolState
{
    // Transform destination;

    public Viking1MoveState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName, Enemy_Viking1 _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName, _enemy)
    {
    }
