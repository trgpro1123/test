...
public class IceGolemDeathState : EnemyState
{
    public Enemy_IceGolem enemy;
    public IceGolemDeathState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName,Enemy_IceGolem _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName)
    {
        enemy=_enemy;
    }
