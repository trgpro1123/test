...
public class IceGolemBattleState : EnemyState
{
    protected Enemy_IceGolem enemy;

    private bool canAttackPlayer;

    public IceGolemBattleState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName,Enemy_IceGolem _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName)
    {
        enemy=_enemy;
    }
