...
public class IceGolemChasingState : EnemyState
{

    protected Enemy_IceGolem enemy;
    protected Transform transformToMove;
    

    public IceGolemChasingState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName,Enemy_IceGolem _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName)
    {
        enemy=_enemy;
    }
