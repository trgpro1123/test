...
public class Viking2BattleState : EnemyState
{
    protected Enemy_Viking2 enemy;

    private bool canAttackPlayer;

    public Viking2BattleState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName,Enemy_Viking2 _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName)
    {
        enemy=_enemy;
    }
