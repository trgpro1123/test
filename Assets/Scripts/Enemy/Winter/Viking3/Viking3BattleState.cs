...
public class Viking3BattleState : EnemyState
{
    protected Enemy_Viking3 enemy;

    private bool canAttackPlayer;

    public Viking3BattleState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName,Enemy_Viking3 _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName)
    {
        enemy=_enemy;
    }
