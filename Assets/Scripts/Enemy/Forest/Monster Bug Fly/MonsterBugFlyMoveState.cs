...
public class MonsterBugFlyMoveState : MonsterBugFlyPatrolState
{

    public MonsterBugFlyMoveState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName, Enemy_MonsterBugFly _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName, _enemy)
    {
    }
