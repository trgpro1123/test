...
public class MonsterBugFlyBattleState : EnemyState
{
    protected Enemy_MonsterBugFly enemy;

    private bool canAttackPlayer;

    public MonsterBugFlyBattleState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName,Enemy_MonsterBugFly _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName)
    {
        enemy=_enemy;
    }
