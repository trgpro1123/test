...
public class BlueWormMoveState : BlueWormPatrolState
{

    public BlueWormMoveState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName, Enemy_BlueWorm _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName, _enemy)
    {
    }
