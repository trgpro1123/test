...
public class BlueWormBattleState : EnemyState
{
    protected Enemy_BlueWorm enemy;

    private bool canAttackPlayer;

    public BlueWormBattleState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName,Enemy_BlueWorm _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName)
    {
        enemy=_enemy;
    }
