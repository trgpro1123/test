...
public class BossForestMoveState : BossForestPatrolState
{
    // Transform destination;

    public BossForestMoveState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName, Enemy_BossForest _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName, _enemy)
    {
    }
