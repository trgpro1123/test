...
public class MonsterMushroomBattleState : EnemyState
{
    protected Enemy_MonsterMushroom enemy;

    private bool canAttackPlayer;

    public MonsterMushroomBattleState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName,Enemy_MonsterMushroom _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName)
    {
        enemy=_enemy;
    }
