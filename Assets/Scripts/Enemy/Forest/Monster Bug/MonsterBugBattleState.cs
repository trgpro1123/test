...
public class MonsterBugBattleState : EnemyState
{
    protected Enemy_MonsterBug enemy;

    private bool canAttackPlayer;

    public MonsterBugBattleState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName,Enemy_MonsterBug _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName)
    {
        enemy=_enemy;
    }
