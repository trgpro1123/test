...
public class MonsterBugMoveState : MonsterBugPatrolState
{

    public MonsterBugMoveState(Enemy _enemyBase, EnemyStateMachine _enemyStateMachine, string _animateBoolName, Enemy_MonsterBug _enemy) : base(_enemyBase, _enemyStateMachine, _animateBoolName, _enemy)
    {
    }
